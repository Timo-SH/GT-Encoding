...
"""
    Additional GatedGCN layer not implemented in Pytorch, 
    used from the implementation of GraphGPS: https://github.com/rampasek/GraphGPS
"""
class GatedGCNLayer(pyg_nn.conv.MessagePassing):
    ...
    def forward(self, batch):
        ...
        #Message propagation used in the GatedGCN layer
    ...
    def message(self, Dx_i, Ex_j, PE_i, PE_j, Ce):
        ...
        {}e             : [n_edges, out_dim]
        """
        #Message passing function for the GatedGCN algorithm
        e_ij = Dx_i + Ex_j + Ce
    ...
    def aggregate(self, sigma_ij, index, Bx_j, Bx):
        ...
        {}x_j           : [n_edges, out_dim]
        """
        #Aggregation function for GatedGCN
        dim_size = Bx.shape[0]
    ...
    def reset_parameters(self) -> None:
        ...
        self.bn_node_x.reset_parameters()
        self.bn_edge_e.reset_parameters()
